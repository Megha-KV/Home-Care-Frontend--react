...
import { createPatient } from "../../api/PatientRegistration.js";
...
function PatientRegistration() {
  ...
  const handleSave = async () => {
    ...
    try {
      const responseData = await createPatient(data);
      console.log("POST Response:", responseData);
      navigate('/schedule')
      history.pushState('/patient-list')
    } catch (error) {
...
{/* -----------------------insurance-------------------------------------- */}
      ...
      <div className="pr-card-button">
        <Link to="/patient-list" className="pr-new-button">
          View
        </Link>
        <button className="pr-save-next-button" onClick={handleSave}>
